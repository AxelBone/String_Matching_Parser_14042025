...
# === Config ===
INPUT_DIR = "input"          # dossier contenant les <KEY>.json concaténés
OUTPUT_DIR = "output"
HPO_2025_FILE = "HPO_terms_2025.txt"
SELECTED_KEYS_FILE = "selected_keys.txt"  # 1 clé par ligne

# optionnel: filtrage par score pour le nouveau format
MIN_SCORE = None   # ex: 0.5 ; mettre None pour ne pas filtrer
...
for i, filename in enumerate(selected_filenames, start=1):
    ...
    try:
        ...
        # 2) Extraire les HP:xxxx selon format (ancien/nouveau)
