...
def Load_HPO_Local_Preprocessed():
    ...
    hpo_file_name= "hpoterms14042022_en_fr.txt" 
    ...
    if path.exists(preprocessed_file_name):
        ...
        hpo_file_name= "hpoterms14042022.txt" # load the english hpo file
        ...
        HPO_Non_PhAb_IDs=np.load('application/resources/HPO_Non_PhAb_IDs_2025.npy',allow_pickle=True)
        HPO_IDs=hpo_array[:,1]
...
HPO_OBO=Ontology("application/resources/hpo14042022.obo")
